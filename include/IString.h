...
{
    void* implementor;
    char* (*GetString)(void* implementor);
    ...
    IString* (*SubString)(void* implementor, char* string, int pos, int len);
...
extern char* IString_GetString(IString* this);
...
extern IString* IString_SubString(IString* this, char* string, int pos, int len);
